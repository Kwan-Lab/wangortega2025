...
%%
plot_lickrate_byTrialType(lick_trType_array, 0);
...
% for j=1:numel(fname)  %append for each fieldn
%     disp([fname{j} ' - ' num2str(nanmean(bic_array.(fname{j})))]);
% end

%%
x=1; %added HKO 3/1/2023
figure;
